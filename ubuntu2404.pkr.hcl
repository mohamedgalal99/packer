...
locals {
  ...
  new_img_name_ubuntu2404 = "Ubuntu-24.04"
...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "echo 'ubuntu-2404' | sudo tee /etc/hostname",
      "CURRENT_HOSTNAME=$(hostname); grep -q \"127.0.1.1 ubuntu-2404\" /etc/hosts || echo '127.0.1.1 ubuntu-2404' | sudo tee -a /etc/hosts",
